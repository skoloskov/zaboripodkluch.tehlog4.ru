...
$MESS["PAGER_TEMPLATE_TIP"] = "The name of a breadcrumb navigation template. If empty, the default template (<b>tenders</b>) will be used. Alternatively, you can use the <b>orange</b> template.";
