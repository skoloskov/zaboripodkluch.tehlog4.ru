...
if (!isset($pageSettings['UF_DESCRIPTION'])){
	$pageSettings['UF_DESCRIPTION'] = "Заказать под ключ ".$arResult['NAME']." в городе ##CITY##. Фотографии, описание, стоимость под ключ. Отправьте заявку на расчет похожего ограждения с вашими параметрами.";
}
$APPLICATION->SetPageProperty('pageSettings', $pageSettings);