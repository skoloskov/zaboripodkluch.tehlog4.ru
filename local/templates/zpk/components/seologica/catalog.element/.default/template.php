...
$arWaterMark = Array(
	array(
		...
		"type" => "image",
		"size" => "medium",
		"file" => $_SERVER["DOCUMENT_ROOT"].SITE_TEMPLATE_PATH.'/img/logo_zpk.png', // Путь к картинке
		"fill" => "resize",
		"coefficient" => 1		
	)
);
...
<?/*<section class="detail__analog">
	<div class="container detail__analog-container">
		<h2 class="section__title detail__analog-title">Аналогичные виды заборов проверенных компаний</h2>
		<ul class="detail__analog-list">
			<li class="detail__analog-item">
				<a class="detail__analog-link" href="">
					<div class="detail__analog-block-img">
						<img class="detail__analog-img" src="" alt="">
					</div>
					<div class="detail__analog-desc">
						...
						<span class="detail__analog-subtitle">
							Ворота </span>
						<div class="detail__analog-price">от <span class="detail__analog-number">5000 Руб./м.п.</span>
						</div>
					</div>
				</a>
			</li>
			<li class="detail__analog-item">
				<a class="detail__analog-link" href="">
					<div class="detail__analog-block-img">
						<img class="detail__analog-img lazyload" data-src="" alt="">
					</div>
					<div class="detail__analog-desc">
						<div class="rating-block">
							<div class="rating" data-value="5">
		...
		<button type="button" class="detail__analog-btn arsenal__btn">Показать следующие 30 товаров</button>
	</div>
</section>*/?>
<section class="detail__answer">
	<div class="container detail__container">
		...
		<?/*<form action="">
			<fieldset class="detail__fieldset-answer">
				<div class="fieldset-answer__el">
					<lable for="answer__name" class="fieldset-answer__lbl">Ваше имя</lable>
					<input id="answer__name" type="text" class="fieldset-answer__input fieldset-answer__name">
				</div>
				<div class="fieldset-answer__el">
					<lable for="answer__phone" class="fieldset-answer__lbl">Ваш телефон</lable>
					<input id="answer__phone" type="tel" class="fieldset-answer__input fieldset-answer__phone">
				</div>
				<div class="fieldset-answer__el fieldset-answer__el-answer">
					<label class="fieldset-answer__lbl" for="answer__answer">Ваш вопрос</label>
					<textarea name="" id="answer__answer" cols="30" rows="10"></textarea>
				</div>
				<div class="fieldset-answer__el fieldset-answer__el-btn">
					<button type="submit" class="fieldset-answer__btn arsenal__btn">Отправить</button>
				</div>
			</fieldset>
		</form>*/?>
